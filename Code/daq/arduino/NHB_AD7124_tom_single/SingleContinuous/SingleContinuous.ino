...
void setup() {
  ...
  adc.setup[0].setConfig(AD7124_Ref_ExtRef1, AD7124_Gain_128, true, burnout, exRefV);  
  ...
  adc.setChannel(0, 0, AD7124_Input_AIN0, AD7124_Input_AVSS, true);  
